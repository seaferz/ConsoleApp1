...
class Program
{
    ...
    {
        // Первое взвешивание: сравниваем 1 и 2 с 3 и 4
        if (Compare(coins, new int[] { 0, 1 }, new int[] { 2, 3 }) == 0)
        {
            // Первое взвешивание в равновесии - фальшивая монета среди 5 и 6
            if (Compare(coins, new int[] { 4 }, new int[] { 0 }) == 0)
            {
                // Второе взвешивание: 5 и 1 равны, значит фальшивая - 6
                Console.WriteLine("Фальшивая монета: 6");
            }
            else
            {
                // Второе взвешивание: 5 и 1 не равны, значит фальшивая - 5
        ...
        else
        {
            ...
            if (Compare(coins, new int[] { 0 }, new int[] { 1 }) == 0)
            {
                // Второе взвешивание: 1 и 2 равны, значит фальшивая - 3 или 4
                if (Compare(coins, new int[] { 2 }, new int[] { 0 }) != 0)
                {
                    // Третье взвешивание: 3 и 1 не равны, значит фальшивая - 3
                    Console.WriteLine("Фальшивая монета: 3");
                }
                else
                {
                    // Третье взвешивание: 3 и 1 равны, значит фальшивая - 4
                    Console.WriteLine("Фальшивая монета: 4");
                }
            }
            else
            {
                // Второе взвешивание: 1 и 2 не равны, значит фальшивая либо 1, либо 2
                if (Compare(coins, new int[] { 0 }, new int[] { 1 }) > 0)
                {
                    // 1 тяжелее 2, значит фальшивая - 1
                    Console.WriteLine("Фальшивая монета: 1");
                }
                else
                {
                    // 2 тяжелее 1, значит фальшивая - 2
                    Console.WriteLine("Фаль
